...
class TestModule:
    ...
    def test_module(self):
        ...
        #assert 0 == b.get_command().find("module purge --force")
...
class TestModuleCollection:
    ...
    @pytest.mark.xfail(reason="Type error when a non-string argument to ModuleCollection class",raises=TypeError)
