...
python buildtest.py -s Python/2.7.12 -t foss/.2016.03 --testset mpi
...
python buildtest.py -s OpenMPI/2.0.0 -t gcccuda/.2016.03 --testmpi mpi
...
python buildtest.py -s Anaconda2/4.2.0 -t GCC/5.4.0-2.27 --testset mpi
