...
_buildtest ()
{
  ...
  case "$next" in
    build|bd)
      ...
      local longoption="--account --buildspec --dry-run --executor --executor-type --exclude --exclude-tags --filter --helpfilter --limit --maxpendtime --max-jobs --modules --module-purge --name --nodes --pollinterval --procs --profile --rebuild --rerun --remove-stagedir --retry --save-profile --strict --suppress --tags --testdir --timeout --unload-modules --validate --write-config-file"
