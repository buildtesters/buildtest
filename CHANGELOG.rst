...
- Rename command line options `--max-pend-time` to `--maxpendtime` and `--poll-interval` to `--pollinterval` `#959 <https://github.com/buildtesters/buildtest/pull/959>`_
...
- Add new command **buildtest stylecheck** to run style checks such as *isort*, *black* and *pyflakes*. See `#964 <https://github.com/buildtesters/buildtest/pull/964>`_, `#965 <https://github.com/buildtesters/buildtest/pull/965>`_, `#969 <https://github.com/buildtesters/buildtest/pull/969>`_
