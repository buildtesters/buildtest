...
- Add new option ``buildtest build --modules`` and ``buildtest build --module-purge`` which allows one to specify modules to load on command line and purging modules command before running any test. `#1004 <https://github.com/buildtesters/buildtest/pull/1004>`_
