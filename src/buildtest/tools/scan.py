...
"""
This python module will implement the buildtest --scantest option which shows tests
that can be run with buildtest by searching what is available in your system
"""
