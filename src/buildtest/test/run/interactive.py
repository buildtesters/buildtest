...
def systempkg_test_menu(systempkgpath, pkg_name):
    """ main menu for a selected system package and shows all the tests"""
    os.system("clear")
...
def launch_test(testdir,test):
    """ method that runs the test in the interactive menu"""
    os.chdir(testdir)
...
def userprompt():
    """ method to control navigation between different menus"""
    text = """
...
def runtest_menu():
    """ main menu when run buildtest run --interactive"""
    os.system("clear")
