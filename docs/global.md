...
```json
{"$ref":"https://buildtesters.github.io/buildtest/schemas/global.schema.json#/definitions/env"}
```
...
```json
{"$ref":"https://buildtesters.github.io/buildtest/schemas/global.schema.json#/definitions/tags"}
```
...
```json
{"$ref":"https://buildtesters.github.io/buildtest/schemas/global.schema.json#/definitions/skip"}
```
...
```json
{"$ref":"https://buildtesters.github.io/buildtest/schemas/global.schema.json#/definitions/executor"}
```
...
```json
{"$ref":"https://buildtesters.github.io/buildtest/schemas/global.schema.json#/definitions/sbatch"}
```
...
```json
{"$ref":"https://buildtesters.github.io/buildtest/schemas/global.schema.json#/definitions/bsub"}
```
...
```json
{"$ref":"https://buildtesters.github.io/buildtest/schemas/global.schema.json#/definitions/status"}
```
