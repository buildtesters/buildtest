...
buildtest requires a Python 3.10 or higher, we recommend you setup a python environment in order
...
.. tab-set::
    ...
    .. tab-item:: Conda
       ...
       .. code-block:: console
           ...
           conda create -n buildtest python=3.10
...
please note the python wrapper must be 3.10 or higher in-order for buildtest to function properly.
