...
cd /lustre/workspace/home/hpcswbuild/hpcswadm/jenkins/buildtest/Durham/eb-2018/IvyBridge/test/buildtest-framework
...
export BUILDTEST_MODULE_ROOT=/nfs/grid/software/easybuild/IvyBridge/redhat/7.3/modules/all
