...
cd /lustre/workspace/home/hpcswbuild/hpcswadm/jenkins/buildtest/Durham/eb-2018/SkyLake/test/buildtest-framework
...
export BUILDTEST_MODULE_ROOT=/nfs/grid/software/easybuild/SkyLake/redhat/7.3/modules/all
