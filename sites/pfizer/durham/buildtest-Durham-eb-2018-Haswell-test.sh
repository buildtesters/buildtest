...
cd /lustre/workspace/home/hpcswbuild/hpcswadm/jenkins/buildtest/Durham/eb-2018/Haswell/test/buildtest-framework
...
export BUILDTEST_MODULE_ROOT=/nfs/grid/software/easybuild/Haswell/redhat/7.3/modules/all
